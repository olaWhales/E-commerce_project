...
public class SellerTest {
    ...
    public void testToCreateProduct() {
        ProductResponse productResponse = productsService.addProduct(new ProductRequest());
        Product product = new Product();
        product.setProductName("Phone");
        product.setProductDescription("it's a green color");
        product.setProductPrice(10000);
        product.setProductQuantity(Integer.valueOf(String.valueOf(20)));
        ...
        assertEquals(productResponse.getMessage() , "Product successfully");
    }
